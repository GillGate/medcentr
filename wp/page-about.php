...
<section class="aboutIntro">
	<div class="container aboutIntro__wrapper">
		<h1 class="h1 aboutIntro__title">С 2010 года оказываем полный спектр услуг по лицензированию медицинской деятельности</h1>
		<p class="h2 aboutIntro__caption">
			Мы работаем исключительно в интересах соискателя лицензии, понимая медицинский бизнес изнутри.
		</p>
	</div>
</section>
<section class="partners">
	<div class="container">
		<div class="partners__wrapper">
			<p class="partners__title">Среди наших клиентов</p>
			<div class="partners__slider">
				<?php foreach(getPartners() as $partner) { ?>
					<div class="partners__item">
						<a href="<?php echo $partner['partner-link']; ?>" target="_blank" rel="noopener">
							<?php echo $partner['img']; ?>
						</a>
					</div>
				<?php } ?>
			</div>
			<div class="slider__dots partners__dots"></div>
		</div>
	</div>
</section>
<section class="aboutAdvantage">
	<div class="container aboutAdvantage__wrapper">
		<div class="aboutAdvantage__info">
			<h2 class="h2 aboutAdvantage__title">
				О нас
			</h2>
			<p class="text aboutAdvantage__text">
				11-летний опыт фокусировки только на медицине, позволяет нам помогать Вам не только с точки зрения права, но и с точки зрения комфорта врачей и клиентов клиники, и при проектировании кабинетов, и на следующих этапах.
			</p>
		</div>
...
<section class="mission">
	<div class="container mission__wrapper">
		<h2 class="h1 mission__title">
			Миссия
		</h2>
	</div>
</section>
<section class="team <?php if(count(getTeam()) % 2 === 0) echo "team--even" ?>">
	<div class="container">
		<p class="h1 team__title">
			С 2010 года оказываем полный спектр услуг по лицензированию медицинской деятельности
		</p>
		<div class="team__info">
			<h2 class="h2 team__infoTitle">Команда</h2>
			<p class="text team__infoText">
				Мы команда профессионалов, узко специализируемся на работе в медицинской сфере.
			</p>
		</div>
		<div class="team__list">
			<?php foreach(getTeam() as $member) { ?>
				<div class="team__item member">
					<div class="member__img">
						<?php echo $member['img']; ?>
					</div>
					<div class="member__info">
						<h3 class="member__title"><?php echo $member['name']; ?></h3>
						<p class="member__caption"><?php echo $member['team-position']; ?></p>
						<div class="member__text">
							<?php echo $member['team-description']; ?>
						</div>
					</div>
				</div>
			<?php } ?>
		</div>
		<div class="slider__controls team__controls">
			<button class="slider__button team__button team__button--prev">
			...
			<button class="slider__button team__button team__button--next">
